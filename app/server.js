...
const checkJwt = jwt({
  secret: jwksRsa.expressJwtSecret({
    ...
    jwksUri: 'https://<auth0_tenant_name>.us.auth0.com/.well-known/jwks.json'
  }),

  audience: 'https://mybank-api-2.test',
  issuer: 'https://<auth0_tenant_name>.us.auth0.com/',
  algorithms: [ 'RS256' ]
});
...
app.get("/", async ( request, response) => {
    ...
    console.log("Welcome to Fady Hakim demo - MyBank API 2");
